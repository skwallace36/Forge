...
class CommandPaletteWindowController: NSWindowController, NSTextFieldDelegate, NSTableViewDataSource, NSTableViewDelegate {
    ...
    private func buildCommands() {
        allCommands = [
            ...
            PaletteCommand(title: "Toggle Bookmark", shortcut: "⌘F2", category: "Edit",
                           action: #selector(EditorContainerViewController.toggleBookmark(_:)), target: nil),
            PaletteCommand(title: "Next Bookmark", shortcut: "F2", category: "Edit",
                           action: #selector(EditorContainerViewController.nextBookmark(_:)), target: nil),
            PaletteCommand(title: "Previous Bookmark", shortcut: "⇧F2", category: "Edit",
            ...
            PaletteCommand(title: "Next Occurrence", shortcut: "⌃⌥↓", category: "Edit",
                           action: #selector(EditorContainerViewController.nextOccurrence(_:)), target: nil),
            PaletteCommand(title: "Previous Occurrence", shortcut: "⌃⌥↑", category: "Edit",
                           action: #selector(EditorContainerViewController.previousOccurrence(_:)), target: nil),
            ...
            PaletteCommand(title: "Toggle Sticky Scroll", shortcut: "", category: "View",
                           action: #selector(EditorContainerViewController.toggleStickyScroll(_:)), target: nil),
            PaletteCommand(title: "Toggle Inline Diagnostics", shortcut: "", category: "View",
                           action: #selector(EditorContainerViewController.toggleInlineDiagnostics(_:)), target: nil),
            ...
            PaletteCommand(title: "Show Build Log", shortcut: "⌃⌘1", category: "View",
                           action: #selector(MainSplitViewController.showBottomTab1(_:)), target: nil),
            PaletteCommand(title: "Show Problems", shortcut: "⌃⌘2", category: "View",
                           action: #selector(MainSplitViewController.showBottomTab2(_:)), target: nil),
            PaletteCommand(title: "Show Terminal", shortcut: "⌃⌘3", category: "View",
                           action: #selector(MainSplitViewController.showBottomTab3(_:)), target: nil),
            PaletteCommand(title: "Show Claude", shortcut: "⌃⌘4", category: "View",
                           action: #selector(MainSplitViewController.showBottomTab4(_:)), target: nil),
            PaletteCommand(title: "Show Search", shortcut: "⌃⌘5", category: "View",
